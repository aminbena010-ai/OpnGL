# Fuente bitmap 8x8 de dominio público (font8x8_basic, Daniel Hepper).
# Cada glifo son 8 bytes; el bit MSB es el píxel superior-izquierdo.
# Se usa para generar el atlas de texto de la UI sin dependencias externas.
...
FONT8X8 = {
    ...
    0x4E: (0x63,0x67,0x6F,0x7B,0x73,0x63,0x61,0x00),
    ...
    0x6E: (0x00,0x00,0x3B,0x6E,0x66,0x66,0x67,0x00),
